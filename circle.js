...
// You can try to understand the mechanical physics formulas or simply take them from the java version of the simulator on:  http://algs4.cs.princeton.edu/61event/
function Circle(x, y, radius, mass, vX, vY) {
  ...
  this.bounceOff = function(that) {
    ...
    var dvdr = dx*dvx + dy*dvy;             // dot product
    var dist = this.radius + that.radius;   // calculate the distance between particles
